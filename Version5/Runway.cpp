...
Error_code Runway::can_land(const Plane &current, bool urgent_land)
/*
...
{
   Error_code result;
   if (current.getState() == arriving_out_of_fuel && urgent_land)
        result = success;
...
*/
{
    switch (process) {
        ...
        case 2:
            ...
            break;
        case 3:
            cout << time << ": Extra runway is idle." << endl;
            break;
    }
}
